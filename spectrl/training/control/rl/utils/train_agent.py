...
from spectrl.training.control.rl.utils.make_train_plots import make_train_plots
from spectrl.training.control.rl.utils.gym_env import GymEnv
from spectrl.training.control.rl.samplers.core import sample_paths
import numpy as np
...
def train_agent(
    ...
    for i in range(niter):
        ...
        if i >= 1:
            perfs.append(
                (train_curve[i] - train_curve[i - 1]) / abs(train_curve[i - 1])
            )
        # if i > 25:
